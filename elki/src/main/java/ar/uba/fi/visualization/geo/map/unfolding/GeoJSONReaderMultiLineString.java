package ar.uba.fi.visualization.geo.map.unfolding;
 ...
 *  GeoJSONReader version with fix for MultiLineString: https://github.com/tillnagel/unfolding/blob/fa367eb6274a46e62c43a4261b3a6385ea983bac/src/de/fhpotsdam/unfolding/data/GeoJSONReader.java, 
 *  https://forum.processing.org/two/discussion/7270/unfolding-maps-geojson-and-multilinestring
 *    The new version with the fix is no available
 *
 */
public class GeoJSONReaderMultiLineString extends GeoDataReader {
   ...
   * @return A list of features.
   */
  public static List<Feature> loadData(PApplet p, File file) {
    return loadDataFromJSON(p, PApplet.join(PApplet.loadStrings(file), ""));
  }
